...
import OceanProducts from './oceanComponents/OceanProducts'
import OceanContactUs from './oceanComponents/OceanContactUs'

function SvgPathOnScroll() {
  useEffect(() => {
  ...
  return (
    <section id='SvgPathOnScrollWrapper'>
      ...
      <div className='seaFloor'>
        <div className='seaFloorLinks'></div>
        <p className='copyRight'>© 2021 - Website made by Adrian Perdomo</p>
      </div>
    </section>
  )
}

export default SvgPathOnScroll
